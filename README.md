...
### Full paper base + Colab rerun runner
...
The GitHub Actions workflow tests the installable package on Python 3.10,
3.12 and 3.13 without downloading multi-gigabyte assets. Full figure and visual-asset
