"""Publication style helpers for the DeepSTARR motif supplement."""
...
MID = "#666666"
GRID = "#D9D9D9"
TASK_COLORS = {"HK": "#54A24B", "DEV": "#4C78A8", "CAGE": "#B84A4A"}
LOCATION_COLORS = {"Proximal": "#6C8AE4", "Distal": "#8A8A8A"}
...
def set_pub_style(font_size: float = 10.5) -> None:
    mpl.rcParams.update(
        {
            "font.family": "Arial",
